...
class PagePostTest extends StatefulWidget {
  const PagePostTest({super.key});

  @override
  State<PagePostTest> createState() => _PagePostTestState();
}

class _PagePostTestState extends State<PagePostTest> {
                              ...
                              child: AnimatedOpacity(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
                                    color: feedback.contains("Excellent")
                                        ? Colors.greenAccent
                                        : Colors.redAccent,
                                  ),
                                ),
